...
function UpdateSetting() {
	...
	useEffect(() => {
		if (settings) {
			...
			setIsEnq(isEnqTitleEnable)
			setIsPay(isEnableStripe)
			setIsLogo(isLogoEnable)
			setLogo(instituteLogo)
		}
	}, [])
	...
	const submitHandler = async (e) => {
		...
		await axios.patch(`/api/v1/setting/update/${settings._id}`, setting, {
			headers: {
